...
function M.get_groups(colors, config, utils)
	...
	local groups = {
		...
		CursorLine = { bg = colors.floatingBg },
		...
		Folded = { fg = colors.mainText, bg = colors.floatingBg },
		...
		MatchParen = { fg = colors.damasquinado, bold = true, bg = colors.floatingBg },
		ModeMsg = { link = "Normal" },
		MsgArea = { link = "Normal" },
		-- MsgSeparator = {},
		...
		WarningMsg = { fg = colors.warningText, bg = colors.floatingBg },
		Whitespace = { fg = colors.cementBH },
		...
		DiagnosticHint = { fg = colors.cementBH, bg = colors.sidebarBg },
