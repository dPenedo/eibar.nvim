...
function M.get(c, config, utils)
  ...
  return {
		...
		["@keyword.return"] = { fg = c.keywordSpecial, bold = true, italic = config.italics.keywords or false },
		["@keyword.exception"] = { fg = c.keywordSpecial},
		-- ["@storageclass"] = {},
		-- ["@structure"] = {},
		["@namespace"] = { link = "Type" },
  ...
  ["@lsp.type.enumMember.markdown"] = {fg = c.commentText},
    ...
    ["@markup.heading.2.markdown"] = { link = "@constant.builtin"},
    ["@markup.heading.3.markdown"] = {link = "@Method"},
    ["@markup.heading.4.markdown"] = {fg = c.morea},
    ...
    ["@markup.raw.markdown_inline"] = { fg = c.sanAndres, bg = c.base02 },
